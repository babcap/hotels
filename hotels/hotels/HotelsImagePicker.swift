...
protocol HotelsImagePickerDelegate: AnyObject {
    ...
    func cancelButtonDidClick(on imageView: HotelsImagePicker)
}

class HotelsImagePicker: NSObject {

    private weak var controller: UIImagePickerController?
    weak var delegate: HotelsImagePickerDelegate? = nil
...
extension HotelsImagePicker: UINavigationControllerDelegate { }

// MARK: UIImagePickerControllerDelegate

extension HotelsImagePicker: UIImagePickerControllerDelegate {
